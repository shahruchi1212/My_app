...
import { _DEVICE_HEIGHT } from '../constants/dimens';


// responsive font size that will change on each device based on the height of that device
export const FONT_SIZE = {
  _70: RFValue(70, _DEVICE_HEIGHT),
  _55: RFValue(55, _DEVICE_HEIGHT),
  _50: RFValue(50, _DEVICE_HEIGHT),
  _48: RFValue(42, _DEVICE_HEIGHT),
  _42: RFValue(42, _DEVICE_HEIGHT),
  _38: RFValue(38, _DEVICE_HEIGHT),
